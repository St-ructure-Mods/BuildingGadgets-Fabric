...
/**
 * This class represents a serializer responsible for converting {@link ITileEntityData} into {@link CompoundTag} and back. Of course an {@code ITileDataSerializer}
 ...
 * <p>
 * Additionally the {@link #serialize(ITileEntityData, boolean)} and {@link #deserialize(CompoundTag, boolean)} methods are passed an boolean flag in order to hint
