 ...
 * produce at most via {@link #estimateSize()} in combination with hinting the amount of {@link ItemVariant}'s required.
...
public interface IBuildView extends Iterable<PlacementTarget> {
    ...
    /**
     * Attempts to compute the amount of required {@link ItemVariant}'s. Should never be more than might be needed,
